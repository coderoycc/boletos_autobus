    ...
    <div class="table-responsive">
      <table class="table table-hover table-bordered w-100" id="tickets-table">
        ...
        <?php foreach ($records as $key => $record) { ?>
          <tr>
            <td class="text-center fw-bold"><?= $record['ticket'] ?></td>
            ...
            <td class="text-center">
              ...
              <a class="btn btn-light me-2" href="../tickets/web_print.php?tid=<?= $record['ticket'] ?>" target="_blank" title="Ver Recibo"><i class="fas fa-file-pdf"></i></a>
              <?php } else { ?>
              <button 
                class="btn btn-warning me-2" 
                data-id="<?= $record['ticket'] ?>" 
