...
<body class="sb-nav-fixed">
      ...
      <main>
        <div class="container-fluid px-4">
          <div class="d-flex justify-content-between mt-4 flex-wrap">
            ...
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#location_add"><i class="fa-lg fa-solid fa-map-location-dot"></i> Nuevo destino</button>
          </div>

          <div class="row" id="data_location"></div>
        </div>
      </main>
    </div>
  </div><!-- fin contenedor -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" id="modal_content_edit">
          <form id="form_location_edit" onsubmit="return false;">
            <div class="row">
  ...
  <!-- MODAL AGREGAR -->
  <div class="modal fade" id="location_add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h1 class="modal-title text-white fs-5">AGREGAR NUEVO DESTINO</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form id="form_add_location" onsubmit="return false;">
            <div class="row">
              <div class="col-md-6 mb-2">
                <div class="form-floating">
                  <input type="text" class="form-control" name="location" placeholder="Nombre destino">
                  <label for="location">Nombre de destino</label>
                </div>
              </div>
              <div class="col-md-6 mb-2">
                <div class="form-floating">
                  <input type="text" class="form-control" name="acronym" placeholder="Acronimo">
                  <label for="acronym">Acronimo (opcional)</label>
                </div>
              </div>
            </div>
          </form>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
          <button type="button" class="btn btn-primary text-white" data-bs-dismiss="modal" onclick="add_new()">Agregar</button>
        </div>
      </div>
    </div>
  </div>
